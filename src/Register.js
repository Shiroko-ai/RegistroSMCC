              ...
              <div className='row'>
                ...
                <div className='col-lg-6'>
                  <div className='p-5'>
                    <form className='user' >
                      ...
                      <div className='form-group row'>
                        <div className='col-sm'>
                          <input
                            ...
                            placeholder='Nombre' style={{ color: '#800040' }}
                          />
                        </div>
                        <div className='col-sm'>
                          <input
                            ...
                            placeholder='Apellido Materno' style={{ color: '#800040' }}
                          />
                        </div>
                        <div className='col-sm'>
                          <input
                            ...
                            placeholder='Apellido Paterno' style={{ color: '#800040' }}
                          />
                        </div>
                      </div>
                      ...
                      <div className='form-group'>
                        <input
                          ...
                          placeholder='Ingresa tu numero de trabajador' style={{ color: '#800040' }}
                        />
                      </div>
                      <div className='form-group'>
                        <input
                          type='text' className='form-control form-control-user'
                          id='num_trabajador' aria-describedby='emailHelp'
                          placeholder='Ingresa tu correo' style={{ color: '#800040' }}
                        />
                      </div>
                      <div clsassName='form-group'>
                        <input
                          ...
                          placeholder='Ingresa tu contraseña' style={{ color: '#800040' }}
                        />
                      </div>
                    ...
                    <div className='text-center'>
                      <p className='h4 mb-4' style={{ color: '#800040' }}></p>
                    </div>
                  </div>
                </div>
              </div>
